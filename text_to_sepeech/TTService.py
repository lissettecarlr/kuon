...
sys.path.append('text_to_sepeech/vits')
...
import text_to_sepeech.vits.commons as commons
import text_to_sepeech.vits.utils as utils

from text_to_sepeech.vits.models import SynthesizerTrn
from text_to_sepeech.vits.text.symbols import symbols
from text_to_sepeech.vits.text import text_to_sequence
...
def get_text(text, hps):
    text_norm = text_to_sequence(text,hps.data.symbols ,hps.data.text_cleaners)
