...
class ThinkingThread(threading.Thread):
    def __init__(self,chat,input_queue:Queue,output_queue:Queue):
        super().__init__()
        self.chat = chat
...
class Thinking():
    def __init__(self,input_queue:Queue,output_queue:Queue):
        ...
        self.soul = persona(self.config)
        self.thinking_thread = ThinkingThread(self.soul,input_queue,output_queue)
