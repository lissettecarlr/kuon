...
class Chatgpt():
    def __init__(self,secret_key,proxy="",temperature=0.7,preset=None,
        ...
        if self.proxy:
            ...
            logger.debug("使用代理:{}".format(self.post_url))
...
def main():
    ...
    #chatgpt = chatgpt(args.api_key,memoryTime=10)
    Chatgpt = Chatgpt(args.api_key,memoryTime=10,preset=preset)
